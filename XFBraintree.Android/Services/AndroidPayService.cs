...
using XFBraintree.Models;
using XFBraintree.Services;
...
[assembly: Dependency(typeof(XFBraintree.Droid.Services.AndroidPayService))]
namespace XFBraintree.Droid.Services
{
